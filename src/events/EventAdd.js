...
const EventAdd = (props) => {
  return (
    <form onSubmit={props.onFormSubmit}>
      ...
      <input id="place" type="text" placeholder="Miejsce..." value={props.place} onChange={props.onFieldChange.bind(this, 'newWhere')} />
      ...
      <input id="time" type="text" placeholder="Godzina..." value={props.time} onChange={props.onFieldChange.bind(this, 'newHour')} />
